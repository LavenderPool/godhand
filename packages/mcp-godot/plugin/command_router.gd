...
func _register_commands() -> void:
	var command_classes := [
		...
		preload("res://addons/godot_mcp/commands/scene_3d_advanced_commands.gd"),
		preload("res://addons/godot_mcp/commands/ios_commands.gd"),
		preload("res://addons/godot_mcp/commands/mobile_commands.gd"),
	]
